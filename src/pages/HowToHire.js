  ...
  const array = [
    {
      ...
      longDesc: <p>Despite our Network State being relatively young, we have the distinction of having worked with some of the biggest names in the Solana Ecosystem already. This is testament to the value we bring to our clients and the ecosystem's continued faith in us.
        <br />
        Whether it be Wallets, DeFi, NFT marketplaces, the creator economy, gaming, public goods, infrastructure, governance models or any vertical you can think of, we pride ourselves for having delivered actionable feedback as a community.
      </p>
    },
    {
      image: our_processes,
      ...
      longDesc: <p>Every protocol we review is assigned a Manager who acts as a bridge between the project team and the community. Our deep dive spans a 2 week period where our community of power users dissect through your protocol and social infrastructure delivering valuable feedback on:
        <ul>
    ...
    },
    {
      ...
      longDesc: <p>If you've made it this far, you're another click away from our Store. If you are comfortable in what your purchase would be, click here -
        <a style={{ color: 'white' }} target='_blank' href='store.deanslist.services'>store.deanslist.services</a>
